...
public class ProfileActivity extends AppCompatActivity {
    ...
    private Button signOutBttn,Kisilerim,profil;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Kisilerim = (Button)findViewById(R.id.Kisiler);
        ...
        Kisilerim.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent i = new Intent(ProfileActivity.this,Crud.class);
                startActivity(i);
                finish();
            }
        });
        ...
        profil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(ProfileActivity.this,Yeniprofil.class);
                startActivity(i);
                finish();
            }
        });
